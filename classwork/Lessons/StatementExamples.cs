...
namespace Lessons
{
    public class StatementExamples
    {
        ...
        public void SampleIfElse()
        {
            ...
            if (value >= 15)
            {
                Console.WriteLine("If Statment Executes");
            }
            else
            {
        ...
        public void SampleIfAnd()
        {
            ...
            if(num1 < 20 && num2 > 19)
            {
                Console.WriteLine("If exectues");
            }
            else
            {
                Console.WriteLine("Else exectues");
            }
            Console.WriteLine("After If");
        }
        ...
        public void SampleSwitch (int num)
        {
            ...
            {
                case 1:
                case 5: Console.WriteLine("1 or 5 was chosen");
                break;
                case 10: Console.WriteLine("10 was chosen");
                break;
                case 15: Console.WriteLine("15 was chosen");
                break;
                case 20: Console.WriteLine("20 was chosen");
                break;
                default: Console.WriteLine("No correct number was chosen");
                break;
            }
        }
        ...
        public void SampleDays(DaysOfWeek days)
        {
            switch (days)
            {
                ...
                case DaysOfWeek.Thur:
                    Console.WriteLine("Sill at Work");
                    break;
            }
        }
    }
